...
messages.forEach(function (message) {
  var scrollHeight = message.querySelector("p").scrollHeight;
  var btn = message.querySelector("button");
...
window.addEventListener("keyup", function (e) {
  if ((e.target.nodeName === "INPUT" || e.target.nodeName === "TEXTAREA") && e.target.id) {
...
__webpack_require__(/*! D:\Work\Web\csed_yearbook\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Work\Web\csed_yearbook\resources\sass\app.scss */"./resources/sass/app.scss");
